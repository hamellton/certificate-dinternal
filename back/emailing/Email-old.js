...
const sendCertificate = (useremail, certificateCode) => {
  email.send({
  ...
  }).then(() => console.log(`Certificate has been send to user's email ${useremail}`))
    .catch((err) => console.log(`Error to send certificate ${err}`));
};
